...
Space complexity: O(R*C)O(R∗C), the space used by seen to keep track of visited squares, and shapes.
...
Time and Space Complexity: O(R*C)O(R∗C). The analysis is the same as in Approach #1.
